document.addEventListener("DOMContentLoaded", () => {
  ...
  let goBack = (function() {
    return (
      ...
      function(/*function*/ callback /*, element*/) {
  ...
  function a() {
    xPos = window.pageXOffset;
    let x = xPos;
    if (theNewGoal >= MAXOFFSET - 25) {
      // correct an issue in the end of the ban
  ...
  function prevBlock(windowPosition) {}
});
